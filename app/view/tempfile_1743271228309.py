...
class RegisterWindow(Window):
    ...
    def _testConnect(self):
        ...
        # 检验IP和Port是否为空
        ip = self.machineIPLineEdit.text()
        port = self.machinePortLineEdit.text()
        ...
        # 启动连接线程
        self.connectionThread = ConnectionThread(ip, port, self.connector)
        self.connectionThread.connectionResult.connect(self._onConnectionResult)
